...
var SAOMainPanel = {
	_new : function() {
		...
		panel.getDOM = function () {
			var dom = $('<div id="'+ id + '">\
							<div id="'+ tid +'">Geshi</div>\
							<div id="'+ hid +'">Whoa... So you found it.. This is just used as an emergency backup in case anything goes wrong. If someday I happen to diseappear, or if i leave, I will be available using one of these methods.<br>Even if I leave the internet with a reason, do not trust me, there are a lot of chances I just can\'t talk about things that happened, and then I will be there. Do not trust anyone, really. I lived so much bad and scary experiences when I was younger. As I am writing now, I am mostly known as Geshi, but I also own some other internet usernames. When you\'ll read this, I don\' know how things evolved. If i diseappear, i will post "healya" over the anonops irc. The username I will use is defined somewhere here, but you\'ll have to find it. Really, thanks for staying with me, I love you. </div>\
							<div id="'+ mid +'">\
								<div id="' + raid + '">ZGltZW5zaW9uc2hpZnRAYW5vbm9wcw==</div>\
							</div>\
							<div id="'+ did + '">\
								<div id="' + baid + '"></div>\
							</div>\
...
Menu.createItem('info', 'Info', 'aaaaaaa.');
